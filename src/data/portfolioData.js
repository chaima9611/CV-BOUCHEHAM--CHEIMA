export const portfolioData = [
  ...
  {
    id: 2,
    name: ' Predictive analytic system ',
    languages: ['javascript','Python'],
    languagesIcons: ['fab fa-js','fab fa-python'],
    source: 'https://github.com/chaima9611/Predictive-analytic-system-for-Covid-19-patients.git',
    info: 'predictive analytics system for Covid-19, that can evaluate data of patients to predict the final state of covid-19 patients, whether is it going to improve or worsn. Moreover, it predicts if the patient is going to die or not depending on specific features.',
    //picture: './media/project2.JPG'
  },
  {
    id: 3,
    name: 'CV PORTFOLIO react',
    languages: ['javascript','react','css'],
  ...
  },
  {
    ...
    source: 'https://github.com/chaima9611/My-Blog.git',
    info: 'IN PROGRESS.',
